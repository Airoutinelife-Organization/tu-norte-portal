...
function MediosDePagoPage() {
  return (
    <section className="mx-auto max-w-6xl px-4 py-12 md:px-6 md:py-16">
      <div className="mb-10 flex flex-col gap-4 rounded-3xl bg-gradient-brand p-8 text-primary-foreground shadow-glow md:flex-row md:items-center md:justify-between md:p-10">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-sm opacity-90">
            Elige entre PSE en línea, SuperGiros o nuestras oficinas. Ten a la mano el número de cédula del titular del servicio.
          </p>
        </div>
        <div className="flex items-center gap-2 rounded-2xl bg-white/15 px-4 py-3 text-xs font-semibold ring-1 ring-white/25">
