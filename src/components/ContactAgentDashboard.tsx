...
import {
  ...
  getPurchasingCalls,
  getServiceCalls,
  getHistoricoCallsAgente,
  getEnProgresoCallsAgente,
  type RedisCall,
  type PurchasingCall,
  type ServiceCall,
...
export default function ContactAgentDashboard({
  ...
  const fetchEnProgreso = useServerFn(getEnProgresoCallsAgente);
  ...
  useEffect(() => {
    ...
    return () => { cancelled = true; };
  }, [fetchEnProgreso, activeTab, days, filterMode, rangeStart, rangeEnd, refreshProgreso, agente]);
  ...
  const fetchHistorico = useServerFn(getHistoricoCallsAgente);
  ...
  useEffect(() => {
    ...
    if (activeTab === "historico") {
        ...
        fetchHistorico({ data: { begin, end, agente } })
          .then((res) => {
            if (!cancelled) {
    ...
    return () => { cancelled = true; };
  }, [fetchHistorico, activeTab, days, filterMode, rangeStart, rangeEnd, agente]);
        ...
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-4 px-4 py-4">
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-primary/10 p-1">
              <img src="/images/logo.png" alt="Tu Norte" className="h-full w-full object-contain" />
            </div>
            <div>
